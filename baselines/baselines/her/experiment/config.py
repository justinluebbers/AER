...
def configure_ddpg(dims, params, reuse=False, use_mpi=True, clip_return=True):
    ...
    ###
    if 'use_gan_transitions' in params:
        ddpg_params['use_gan_transitions'] = params['use_gan_transitions']
        ddpg_params['reward_function'] = env.compute_reward
    if 'store_transitions' in params:
        ddpg_params['store_transitions'] = params['store_transitions']
    ###
